    ...
    >
      ...
      <aside className="mpay-summary">
        ...
        <div className="mpay-summary-content">
          <div className="mpay-brand-row">
            {logoUrl ? (
              <img className="mpay-brand-logo" src={logoUrl} alt={`${merchantName} Pay`} />
            ) : (
              <><span className="mpay-brand-mark">M</span><span>{merchantName} Pay</span></>
            )}
          </div>
      ...
      <div className="mpay-action">
        <header className="mpay-action-header">
          <div>
            {logoUrl ? <img className="mpay-mobile-logo" src={logoUrl} alt={`${merchantName} Pay`} /> : <span className="mpay-mobile-brand">{merchantName} Pay</span>}
